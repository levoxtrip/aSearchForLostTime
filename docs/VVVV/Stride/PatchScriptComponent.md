...
![PatchScript Component to Extent Entities Img](../img/PatchScript1.png)
...
![PatchScript Class Settings Img](../img/PatchScriptSettings.png)

*Start* and *ScriptUpdate* work similar to regular start and update(every frame) behavior.

![PatchScript Component to Extent Entities Img](../img/PatchScript2.png)
...
[Download Example File](../files/PatchScriptEntity.vl)